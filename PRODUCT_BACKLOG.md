...
- [x] แสดงได้หลาย window — เรียงเหลื่อมกัน และจำกัดที่ 12 บาน ตัวเก่าสุดหลุดก่อน กันโมเดลที่ยิง block รัวจนกลบจอ
...
- [x] list ของ windows แสดงอยู่ในกลุ่มเมนู Windows ที่เปิดได้จาก menu icon และกดลบได้จากเมนูนั้นๆ — แต่ละบานเป็น submenu {Show, Delete} ไม่ซ่อนคำสั่งลบไว้หลังปุ่ม modifier ที่คนส่วนใหญ่ไม่เจอ
- [x] กดที่เมนูก็แสดง window นั้นขึ้นมา (Show) — pane ที่ถูก Esc ซ่อนไว้ยังอยู่ในเมนูเสมอ
