...
ขับจริงที่ v0.10.202 (build 95ca645): เปิดครบสามแผง, สลับแผงขณะเปิดอยู่, Profile ที่ 14pt และ
ที่ 24pt (เพดาน) ซึ่งยาวเกิน cap แล้ว scroll ในตัวเองจนถึงปุ่ม Save ตามที่ออกแบบไว้, เปิดเมนู
Model แล้วเลือก Claude Opus 5 จริง — แถวเปลี่ยนค่า วงแหวนประ inherited หายไป และบทสนทนา
ประกาศให้เหมือนตอนพิมพ์ `/model`, แล้วกดกลับเป็น default, กด App size L แล้วหน้าต่างตัวละคร
โตจาก 128×149 เป็น 167×194 จริง
